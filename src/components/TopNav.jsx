    ...
    >
      ...
      <div className="flex items-center gap-3 pointer-events-auto bg-slate-900/60 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 text-xs text-slate-300 shadow-xl">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span className="font-medium text-amber-300 underline decoration-amber-400/40 group-hover:text-white transition-colors cursor-pointer">
            Packaging AI
          </span>
        </Link>
      </div>
      ...
      <div className="flex items-center gap-2.5 pointer-events-auto">
        ...
        {/* EXPERIENCE Primary Action Button -> Get Recommendation */}
        <Link
          to="/recommendation"
