export const FRAME_IMAGES = [
  '/frames/chris-robert-yrBT4o7CkmA-unsplash.jpg',
  '/frames/dallas-penner-ycE5ESD8Ah0-unsplash.jpg',
  '/frames/eduardo-prim-3u51-uLQICc-unsplash.jpg',
  '/frames/greta-hartwyk-hnu1lTb3uqU-unsplash.jpg',
  '/frames/heather-gill-VJa9L3ZVBIc-unsplash.jpg',
  '/frames/istockphoto-1425045114-1024x1024.jpg',
  '/frames/istockphoto-2244136980-1024x1024.jpg',
  '/frames/istockphoto-939107290-1024x1024.jpg',
  '/frames/nandhu-kumar-5NGTf4oD8RA-unsplash.jpg',
];

export const FRAME_METADATA = [
  {
    id: 1,
    title: "RAW COMMODITY VULNERABILITY",
    subtitle: "The Challenge of Post-Harvest Decay",
  ...
  {
    id: 2,
    title: "ATMOSPHERIC RESPIRATION DYNAMICS",
    subtitle: "Oxygen & Carbon Dioxide Permeation Kinetics",
  ...
  {
    id: 3,
    title: "MULTI-LAYER LAMINATE ARCHITECTURE",
    subtitle: "Engineering Micro-Layer Polymer Stacks",
  ...
  {
    id: 4,
    title: "MASS BALANCE & PERMEATION KINETICS",
    subtitle: "Fick's Second Law of Diffusion in Polymers",
  ...
  {
    id: 5,
    title: "COLD-CHAIN BREAKDOWN SIMULATION",
    subtitle: "Thermal Shock & Humidity Spike Resilience",
  ...
  {
    id: 6,
    title: "TOPSIS MULTI-CRITERIA OPTIMIZATION",
    subtitle: "Algorithmic Polymer Laminate Ranking Engine",
  ...
  {
    id: 7,
    title: "SHELF-LIFE EXTENSION ACHIEVED",
    subtitle: "Extending Freshness from 14 to 61 Days",
  ...
  {
    id: 8,
    title: "SUSTAINABLE CIRCULAR PACKAGING",
    subtitle: "Zero-Waste Compostable & Recyclable Laminates",
  ...
  {
    id: 9,
    title: "FOOD PACKAGING ENGINE DEPLOYED",
    subtitle: "Launch Analyst Mode or Farmer Quick Mode",
